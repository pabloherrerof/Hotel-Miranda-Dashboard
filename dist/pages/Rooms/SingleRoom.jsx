...
import { getSingleRoom, getSingleRoomStatus, } from "../../features/rooms/roomsSlice";
            ...
            <Card full>
              ...
              <FeaturesRow>
                <CardItem offer discount={singleRoomData.discount}>
                  <h6>Offer Price</h6>
                  <h5>
                    {offerPriceCalc(singleRoomData.price, singleRoomData.discount)}{" "}
                    <span>/per night</span>
                  </h5>
                </CardItem>
              ...
              <FeaturesRow amenities>
                {singleRoomData.amenities.map((amenitie, i) => {
                    return (<CardItem amenitie key={i}>
              ...
              <form onSubmit={onSubmitHandler}>
                <FeaturesRow>
                  <CardItem>
                    <Input>
                      <h6>Room Number</h6>
                      <input type="number" name="roomNumber" defaultValue={roomNumber} onInput={(e) => {
                ...
                <FeaturesRow>
                  <CardItem>
                    <Input>
                      <h6>Price</h6>
                      <input type="number" name="price" defaultValue={price} onInput={(e) => {
                  ...
                  <CardItem>
                    <Input>
                      <h6>Discount</h6>
                      <input type="number" name="discount" defaultValue={discount} onInput={(e) => {
                  ...
                  <CardItem>
                    <RadioInput>
                      ...
                      <Label active htmlFor="state">
                        <input type="radio" name="state" value="AVAILABLE" defaultChecked={status === "AVAILABLE" ? true : false} onChange={(e) => {
                    setStatus(e.target.value);
                }}/>
                        AVAILABLE
                      </Label>
                      <Label inactive htmlFor="state">
                        <input type="radio" name="state" value="BOOKED" defaultChecked={status === "BOOKED" ? true : false} onChange={(e) => {
                    setStatus(e.target.value);
                }}/>
                        BOOKED
                      </Label>
                ...
                <FeaturesRow>
                  <InputBig>
                    <h6>Description</h6>
                    <input type="text" name="description" defaultValue={description} onInput={(e) => {
