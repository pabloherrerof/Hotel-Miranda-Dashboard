...
import { ImageItem, LeftActions, RoomImageItem, StyledLink, TableContainer, TableItem, TableRow, TableTitle, } from "../../components/TableStyled";
import { Button, StatusButton } from "../../components/Button";
import { offerPriceCalc } from "../../features/otherFunctions";
import { CustomDropdown, RightActions, TableActions, } from "../../components/TableStyled";
    ...
    if (roomsStatus === "pending") {
        ...
        <TableActions>
          ...
          <RightActions>
            ...
            <CustomDropdown arrowOpen={<MdOutlineKeyboardArrowUp />} arrowClosed={<MdOutlineKeyboardArrowDown />} options={options} onChange={onChangeHandler} value={"ID"} room/>
          </RightActions>
        </TableActions>
        <TableContainer>
          <thead>
        ...
        <Modal mode="delete" page={"rooms"} showDeleteModal={showDeleteModal} setShowDeleteModal={setShowDeleteModal} itemId={targetId}/>
        <Modal mode="create" page={"rooms"} setShowCreateModal={setShowCreateModal} showCreateModal={showCreateModal}/>
      </>);
    }
};
