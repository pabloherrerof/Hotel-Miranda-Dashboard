...
import { getSingleBooking, getSingleBookingStatus, } from "../../features/bookings/bookingsSlice";
        ...
        if (edit !== true) {
          ...
          <CardContainer full>
            <Card full>
              ...
              <FeaturesRow>
                ...
                <CardItem>
                  <h6>Price</h6>
                  <h4>
                    {totalPriceCalc(searchBookingRoom(bookingData.room).price, bookingData.checkIn, bookingData.checkOut)}{" "}
                    $
                  </h4>
                </CardItem>
              </FeaturesRow>
              ...
              <FeaturesRow amenities>
                {searchBookingRoom(bookingData.room).amenities.map((amenitie, i) => {
                    return (<CardItem key={i} amenitie>
            ...
            <CardImage>
              ...
              <Booked bookStatus={bookedStatusCalc(bookingData.checkIn, bookingData.checkOut)}>
            ...
            <Card>
              ...
              <form onSubmit={onSubmitHandler}>
                <FeaturesRow>
                  <Input>
                    <h6>Guest Name</h6>
                    <input type="text" name="name" value={guestName} onInput={(e) => {
                ...
                <FeaturesRow>
                  <CardItem>
                    <Input>
                    <h6>Check In</h6>
                      <input type="date" name="checkIn" defaultValue={checkIn} onInput={(e) => {
                  ...
                  <CardItem>
                    <Input>
                    <h6>Check Out</h6>
                      <input type="date" name="checkOut" defaultValue={checkOut} onInput={(e) => {
                ...
                <FeaturesRow>
                  <CardItem>
                    <Input>
                      <h6>Order Date</h6>
                      <input type="date" name="orderDate" defaultValue={orderDate} onInput={(e) => {
                  ...
                  <CardItem>
                    <Input>
                      <h6>Room</h6>
                      <input type="text" name="room" defaultValue={roomId} onInput={(e) => {
                ...
                <FeaturesRow>
                    ...
                    <InputBig>
                      ...
                      <input type="text" name="specialRequest" defaultValue={specialRequest} onInput={(e) => {
