...
import { CustomDropdown, LeftActions, RightActions, SearchBar, StyledLink, TableActions, TableContainer, TableItem, TableLink, TableRow, TableTitle, } from "../../components/TableStyled";
...
export const Bookings = () => {
    ...
    const onClickHandler = (e) => {
        ...
        if (option === "All Bookings") {
            ...
            setTableData(bookingsData.filter((booking) => bookedStatusCalc(booking.checkIn, booking.checkOut) ===
                "IN PROGRESS"));
        }
    };
    ...
    if (bookingsStatus === "pending" || bookingsStatus === "idle") {
        ...
        <TableActions>
          ...
          <RightActions>
            <SearchBar>
              <AiOutlineSearch />
              <input type="text" name="users" id="users" onChange={onSearchInputHandler} placeholder="Search By Guestname"/>
            </SearchBar>
        ...
        <TableContainer>
          ...
          <tbody>
            {tableData.map((element) => (<TableRow key={element.id}>
                ...
                <TableItem>
                  <StatusButton status={bookedStatusCalc(element.checkIn, element.checkOut)}>
        ...
        <Modal mode="delete" page={"bookings"} showDeleteModal={showDeleteModal} setShowDeleteModal={setShowDeleteModal} itemId={targetId}/>
        <Modal mode="create" page={"bookings"} setShowCreateModal={setShowCreateModal} showCreateModal={showCreateModal}/>
        <Modal mode="moreInfo" page={"bookings"} setShowNotesModal={setShowNotesModal} showNotesModal={showNotesModal} targetBooking={targetBooking}/>
      </>);
    }
};
